const MainWelcomeCard = () => {
    return (
        <div className="w-full flex justify-center"> {/*This div is here to simulate the div in which the card will be in, 
        please remove it before using it inside the final website code*/}
