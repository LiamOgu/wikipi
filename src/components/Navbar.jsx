...
const Navbar = () => {
  return (
    <div className="navbar px-6 py-4 flex justify-between border-b-1 border-gray-200">
      <div className="flex items-center gap-1"> {/* Left side of the navbar (logo and menu icon) */}
        <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden"> {/* Menu icon for small screens */}
